...
#else
#define LCD_LED_PIN_NUM	 46
#define	LCD_LED(x) ((x == 1) ? rt_pin_write(LCD_LED_PIN_NUM, PIN_HIGH) : rt_pin_write(LCD_LED_PIN_NUM, PIN_LOW))
#endif
//LCD地址结构体
typedef struct
{
...
#define LCD_BASE        ((rt_uint32_t)(0x6C000000 | 0x000007FE))
