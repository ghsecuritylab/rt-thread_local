...
int rt_hw_spi_init(void)
{
    ...
    /* register spi bus */
    {
        ...
        stm32_spi_register(SPI1, &stm32_spi, "spi1");		//注册SPI总线驱动
    }
    ...
    /* attach cs */
    {
        ...
        rt_spi_bus_attach_device(&spi_device, "spi10", "spi1", (void*)&spi_cs);		//注册设备绑定到总线上, user_data一般为spi cs线
    }
#endif /* RT_USING_SPI1 */
